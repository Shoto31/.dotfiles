...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " dev ", " www ", " sys ", " doc "}
...
local myawesomemenu = {
    ...
    { "edit config", terminal.." vim /home/shoto/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("Rlight -U 10") end,
              {description = "-10%", group = "hotkeys"}),
