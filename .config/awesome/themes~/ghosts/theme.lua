...
theme.font = "Mononoki Nerd Font Mono 9"
theme.icon_font = "Mononoki Nerd Font Mono 18"
theme.font_taglist = "Mononoki Nerd Font Mono 13"
theme.max_font = "Mononoki Nerd Fontt Mono 10"
